...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 m-2 pl-4 pt-3 pb-2.5 rounded-lg text-md text-white';
  const normalLink = 'flex items-center gap-5 m-2 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 dark:text-gray-200 hover:bg-light-gray dark:hover:text-black';
  return (
    <div
